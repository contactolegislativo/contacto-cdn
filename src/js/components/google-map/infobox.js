...
export default function(opts) {
  ...
  InfoBox.prototype.createElement = function() {
    ...
    if (!div) {
      ...
      contentDiv.className = "popover-body hstack";
      ...
      title.className = "pt-1 mb-0 stack-fit";

      var titleClose = document.createElement("button");
      titleClose.innerHTML = "x";
      titleClose.className = "btn btn-sm btn-outline-dark stack-fix";

      var close = document.createElement("div");
      close.className = "arrow";

      var header = document.createElement("div");
      header.className = "popover-header hstack";
      header.appendChild(title);
      header.appendChild(titleClose);
